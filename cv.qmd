...
::: p-2
![](assets/img/uu-logo.png){width="80px" fig-alt="Uppsala University logo"}
:::
...
[PhD student]{.h5} [Oct 2021 -- Present]{.cv-date}
...
::::: {.d-inline-flex style="align-items:baseline"}
::: p-2
![](assets/img/HUPH.png){width="80px" fig-alt="HUPH logo"}
:::
...
[Research Assistant, Center for Public Health and Ecosystem Research]{.h5} [Nov 2015 -- May 2019]{.cv-date}
...
::::: {.d-inline-flex style="align-items:baseline"}
::: p-2
![](assets/img/liege.png){width="60px" fig-alt="Liege University logo"}
:::
...
::::: {.d-inline-flex style="align-items:baseline"}
::: p-2
![](assets/img/hmu.png){width="60px" fig-alt="Hanoi Medical University"}
:::
...
![](assets/img/avise.png){width="60px" fig-alt="avise logo" style="padding-right:1em"} [The Association of Vietnamese Science and Technology Experts in Sweden (AVISE)](https://www.linkedin.com/groups/14482383/)

![](assets/img/AE_logo.png){width="60px" fig-alt="AE logo" style="padding-right:1em"} [Applied Epi Community](https://community.appliedepi.org/)

![](assets/img/globelife.png){width="60px" fig-alt="GlobeLife" style="padding-right:1em"} [GlobeLife](https://www.globelife.se/w/gl/en)

## {{< fa book >}} Publication

[Link to my Google Scholar profile](https://scholar.google.com/citations?user=F2Rlba0AAAAJ&hl=en&authuser=1) *(14 peer-reviewed, h-index: 7, i10-index: 4, total number of citations: 110)*

**Selected 5 articles:** 

1. `Luong NT`, Didier W, Mats M, Tiscar G, Peter SJ (2024) Characterizing proximal and distal drivers of antimicrobial resistance: An umbrella review. Journal of Global Antimicrobial Resistance
   
2. `Luong NT`, Didier W, Mats M, Peter SJ (2024) Characterizing proximal and distal drivers of antimicrobial resistance: An umbrella review. Journal of Global Antimicrobial Resistance
   
3. Peter SJ, `Luong NT` and 10 co-authors (2024). Association between national action and trends in antibiotic resistance: an analysis of 73 countries from 2000 to 2023
