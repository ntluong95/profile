...
[Doctoral degree in Global Health]{.h5} [Oct 2021 -- Nov 2025]{.cv-date}
...
![](assets/img/SRC_SU_logo.svg){fig-alt="Stockholm University logo" width="180"}
:::
...
[Postdoctoral Researcher, ERC project]{.h5} [Jan 2026 -- Jan 2028]{.cv-date}

-   Studies the dynamics and cascading impacts of Emerging Pests and Pathogens (EPPs), including infectious diseases affecting humans, livestock, wildlife, and agricultural systems
-   Investigates when and how EPP outbreaks emerge, how their impacts propagate across social, ecological, and economic systems, and their interactions with broader sustainability challenges and the Sustainable Development Goals
-   Develops data-driven approaches to capture EPP dynamics beyond traditional surveillance systems by combining automated text mining methods (natural language processing and large language models) with expert curation and comparative analysis
-   Extracts information from unstructured textual sources (news media, scientific literature, policy documents) to improve understanding of outbreak drivers, public and policy responses, and downstream societal impacts of EPPs
...
-   **Cardio project**: A Retrospective, Non-Interventional Cohort Study to Evaluate the Clinical Burden, Treatment Outcomes, and Healthcare Utilization in Patients with Amyloidosis Cardiomyopathy (ATTR-CM) Using Swedish National Registries
-   Contributing to the development of the Statistical Analysis Plan (SAP), designing mock shells, and supporting data analysis
...
[Link to my Google Scholar profile](https://scholar.google.com/citations?user=F2Rlba0AAAAJ&hl=en&authuser=1) *(15 peer-reviewed, h-index: 8, i10-index: 8, total number of citations: 197)*

**Selected 5 articles:** 

1. Lea K,`Nguyen TL`, and 11 co-authors (2026). Correlation between heat exposure and perinatal depression-A spatial case-crossover study from Bangladesh, Lesotho, Mozambique, and Nepal. Science of The Total Environment

2. `Luong NT`, Didier W, Mats M, Peter SJ (2025). ‘When global health meets global goals’: assessing the alignment between antimicrobial resistance and sustainable development policies in 10 African and Asian countries. *BMJ Global Health*

3. Peter SJ, `Luong NT` and 10 co-authors (2025). Association between national action and trends in antibiotic resistance: an analysis of 73 countries from 2000 to 2023. *PLOS Global Public Health*

4. `Luong NT`, Didier W, Mats M, Tiscar G, Peter SJ (2024) Characterizing proximal and distal drivers of antimicrobial resistance: An umbrella review. *Journal of Global Antimicrobial Resistance*

5. Ngo HTH, `Nguyen TL`, and 6 co-authors (2021). Microbial contamination and associated risk factors in retailed pork from key value chains in Northern Vietnam. *Food Microbiology *
